...
export const slash = [
  new SlashCommandBuilder()
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("code").setDescription("ISO code").setRequired(true)
        )
    )
    .addSubcommand((sc) =>
      sc.setName("show").setDescription("Show your language")
    ),
  ...
  // NEW: channel mode command
  new SlashCommandBuilder()
    .setName("mode")
    .setDescription("Set auto-translate mode for this channel")
    .addStringOption((o) =>
      o
        .setName("value")
        .setDescription(
          "reply = keep original; replace = delete & re-post translated"
        )
        .setRequired(true)
        .addChoices(
